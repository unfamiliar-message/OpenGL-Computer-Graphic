...
public:
	...
	SpotLight() {
		...
		spotLightCutoffStartInDegree = 0;
		spotLightTotalWidthInDegree = 0;
		// -------------------------------------------------------
		CreateVisGeometry();
	}
	SpotLight(const glm::vec3 p, const glm::vec3 I, const glm::vec3 D, const float cutoffDeg, const float totalWidthDeg) {
		...
		// Add your initialization code here.
		direction = D;
		spotLightCutoffStartInDegree = cutoffDeg;
		spotLightTotalWidthInDegree = totalWidthDeg;
		// -------------------------------------------------------
		CreateVisGeometry();
	}
	...
	float GetspotLightCutoffStartInDegree() const { return spotLightCutoffStartInDegree; }
	float GetspotLightTotalWidthInDegree() const { return spotLightTotalWidthInDegree; }
...
private:
	...
	// -------------------------------------------------------
	// Add your methods or data here.
	float spotLightCutoffStartInDegree;
	float spotLightTotalWidthInDegree;
	glm::vec3 direction;
	// -------------------------------------------------------
};
